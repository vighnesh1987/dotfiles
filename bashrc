export DATABASEDOTCOM_CLIENT_ID=3MVG9rFJvQRVOvk4Z6oWgC.4J9N7.hhsV9M0lmu6lXm4P.CIAn75mB7tJR4q7WxpAv0GCnj7PDEHgV7w2v_0w
export DATABASEDOTCOM_CLIENT_SECRET=3814421384163897504

#PATH=$PATH:$HOME/.rvm/bin # Add RVM to PATH for scripting
PATH=/usr/local/bin:$PATH
PATH=/Library/PostgreSQL/9.1/bin:$PATH
#CDPATH=".:~:~/Dropbox/:~/Dropbox/Courses/Spr12/"
...
alias ggrails='gg --exclude-dir ".idea" --exclude-dir "vendor" --exclude-dir "tmp" --exclude-dir "log" --exclude-dir ".git"'
...
alias txt2pdf="/Users/Rege/Downloads/Software/txt2pdf-10.2m/txt2pdf.pl"

# Stanford specific
alias afs="cd /afs/ir.stanford.edu/users/r/e/rege"
